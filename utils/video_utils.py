...
"""
output_video_frames is expected to be a list or array of numpy arrays, where each numpy array represents an image frame.
...
def save_video(output_video_frames, output_video_path):
    ...
    """
    fourcc = cv2.VideoWriter_fourcc(*'XVID')  # assinging video format XVID
